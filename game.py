...
class Game():
    def __init__(self):
        pygame.init()
        self.GAME_W, self.GAME_H = 480, 480
    ...
    def load_assets(self):
        ...
        self.font["head"] = pygame.font.Font(os.path.join(
            self.font_dir["head"], "RobotoMono-VariableFont_wght.ttf"), 50)
        self.font_dir["text"] = os.path.join(self.assets_dir, "font")
        self.font["text"] = pygame.font.Font(os.path.join(
            self.font_dir["text"], "PressStart2P-vaV7.ttf"), 10)
